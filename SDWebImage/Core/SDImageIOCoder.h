 ...
 *
 * HEIC:
 * This coder also supports HEIC format because ImageIO supports it natively.
 * But it depends on the system capabilities, so it won't work on all devices.
...
/**
 * Returns the shared instance of the image IO coder.
 * This is a singleton instance for convenience.
 *
 * @return The shared coder instance
 */
